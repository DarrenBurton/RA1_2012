...
cutTreePhoton,junkVar,junkVar2 = MakePhotonMC(100.)
...
# 0 = PUS4_Lower # 1 = PUS4_Higher # 2 = PUS6_2011 # 3 = MC_2012 # 4 = Photon_MC
number = 2
#=======
...
outDir = "../../results_"+strftime("%d_%b")+"//PhotonNoSmear/"
