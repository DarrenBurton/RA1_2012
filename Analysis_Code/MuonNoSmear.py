...
cutTreeMC,junkVar,junkVar2,junkVar3,l = MakeMCTree(100.,Muon = True)
#cutTreeMC,junkVar,junkVar2,l = MakeMCTree(100.,Muon = True,Split="WJet_Test")
...
#anal_ak5_caloMC.Run(outDir,conf_ak5_caloMC,[TTJets])
